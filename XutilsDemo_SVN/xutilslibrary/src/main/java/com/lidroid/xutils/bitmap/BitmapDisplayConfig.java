...
public class BitmapDisplayConfig {
    ...
    private BitmapSize bitmapMaxSize;//位图的宽和高相关的参数
    private Animation animation;//动画机制
    private Drawable loadingDrawable;//加载中的drawable
    private Drawable loadFailedDrawable;//加载失败的drawable
    private boolean autoRotation = false;//是否自动选转
    private boolean showOriginal = false;//展现
